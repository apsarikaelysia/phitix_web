...
@section('title', 'Data Pengeluara Pakan')
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($datapengeluaranpakan as $data)
                                            <tr>
                                                <td>{{ $no++ }}</td>
                                                <td>{{ $data->tanggal }}</td>
                                                <td>{{ $data->totalpakan }} Kg</td>
                                                <td>Rp. {{ number_format($data->total) }}</td>
                                                <td>
                                                    <a class="btn btn-primary btn-sm"
                                                        href="/datapengeluaranpakan/{{ $data->id }}">Detail</a>
                                            ...
                                            <div class="modal fade" id="deleteModal{{ $data->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/datapengeluaranpakan/{{ $data->id }}"
                                                            method="post">
                                                            @csrf
                                                            @method('delete')
                                ...
                                <div class="modal fade" id="addModal" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="/datapengeluaranpakan" method="POST">
                                                @csrf
                                                @method('POST')
                                                <div class="modal-body">
                                                    <div class="form-group">
